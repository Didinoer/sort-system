        ...
        <div class="col-lg-8">
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td><a class="btn btn-xs btn-primary btn-flat btn-sm" href="pindah_sparta/{{$item -> id}}">Pindah Group</a></td>
                </tr>
            @endforeach
            </table>
...
{{-- <div class="col-lg-8 mx-auto mt-4 mb-4">
    <input type="search" name="search" id="search" placeholder="Masukkan nama" class="form-control">
</div> --}}
              ...
              <tr>
                ...
                <td>
                    <table>
                        ...
                        <tbody>
                        @foreach ($item -> peserta_sparta as $items)
                            <tr>
                                <td>{{ $loop -> index+1 }}</td>
                                <td>{{ $items['name'] }}</td>
                                <td>{{ $items['umur'] }}</td>
                                ...
                                <td><a class="btn btn-xs btn-primary btn-flat btn-sm" href="pindah_sparta/{{ $items->id }}">Pindah Group</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
...
<script>
    $(document).ready(function() {
        $('#dataTable').DataTable()({
            "order": [[ 5, "asc" ]],
            // Use column index 5 (Kode group) for sorting in ascending order
        });
    });
</script>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="table table-hover table-bordered" style=" border-color :black;">
                                ...
                                <tbody>
                                    @foreach ($item->peserta_sparta as $participant)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            ...
                                            <td><a class="btn btn-sm btn-primary" href="pindah_sparta/{{ $participant->id }}">Pindah Group</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
