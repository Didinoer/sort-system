        ...
        <div class="col-lg-8">
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td><a class="btn btn-xs btn-primary btn-flat btn-sm" href="pindah_ninja/{{$item -> id}}">Pindah Group</a></td>
              ...
              <tr>
                ...
                <td>
                    <table>
                        ...
                        <tbody>
                        @foreach ($item -> peserta_ninja as $items)
                            <tr>
                                <td>{{ $loop -> index+1 }}</td>
                                <td>{{ $items['name'] }}</td>
                                <td>{{ $items['umur'] }}</td>
                                ...
                                <td><a class="btn btn-xs btn-primary btn-flat btn-sm" href="pindah_ninja/{{ $items->id }}">Pindah Group</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table class="table table-hover table-bordered" style=" border-color :black;">
                                ...
                                <tbody>
                                    @foreach ($item->peserta_ninja as $participant)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            ...
                                            <td><a class="btn btn-sm btn-primary" href="pindah_ninja/{{ $participant->id }}">Pindah Group</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
