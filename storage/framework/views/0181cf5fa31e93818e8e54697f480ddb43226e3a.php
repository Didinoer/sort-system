...
<body>
    ...
    <table class="table table-warning   ">
        ...
        <tr>
            ...
            <td>
                <form action="/proses_pindah_apache/<?php echo e($peserta['id']); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sort-system 2/app-name/resources/views/pindah-apache.blade.php ENDPATH**/ ?>