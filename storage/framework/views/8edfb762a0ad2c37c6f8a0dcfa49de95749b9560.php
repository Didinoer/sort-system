...
<body>
    ...
    <table class="table table-success">
        ...
        <tr>
            ...
            <td>
                <form action="/proses_pindah_musketeer/<?php echo e($peserta['id']); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <input type="hidden" name="house" value="musketeer">
    ...
    <div>
        <a href="/hasil-musketeer" class="btn btn-warning">Kembali Kehalaman Group Musketeer</a>
    </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sort-system 2/app-name/resources/views/pindah-musketeer.blade.php ENDPATH**/ ?>