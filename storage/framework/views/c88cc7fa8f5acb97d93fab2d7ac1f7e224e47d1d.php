                    ...
                    <tr>
                        ...
                        <td>
                            <table class="table table-hover table-bordered" style=" border-color :black;">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $item->peserta_ninja; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-sm btn-primary" href="pindah_ninja/<?php echo e($participant->id); ?>">Pindah Group</a></td>
                                        </tr>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sort-system 2/app-name/resources/views/hasil_ninja.blade.php ENDPATH**/ ?>