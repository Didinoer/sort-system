...
<body>
    ...
    <table class="table table-danger">
        ...
        <tr>
            ...
            <td>
                <form action="/proses_pindah_sparta/<?php echo e($peserta['id']); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <input type="hidden" name="house" value="sparta">
        ...
        <div>
            <a href="/hasil-sparta" class="btn btn-warning">Kembali Kehalaman Group Sparta</a>
        </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sort-system 2/app-name/resources/views/pindah-sparta.blade.php ENDPATH**/ ?>